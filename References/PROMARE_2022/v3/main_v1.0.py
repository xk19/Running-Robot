...
StateColors = {
    ...
    State.mine: {"this": ["white2", "white_mine"], "next": "blue_mine", "obj": "black"},
    State.obstacle: {"this": "white2", "next": "", "obj": ""},
    State.door: {"this": "white", "next": "green", "obj": "blue_door"},
    State.bridge: {"this": "green", "next": "", "obj": ""},
    State.ball: {"this": "red", "next": "blue", "obj": "white"},
    State.stair: {"this": "blue_stair", "next": "white_stair", "obj": ["blue_stair", "green", "red"]},
...
color_range = {
    ...
    "blue_door": [(39, 0, 0), (255, 255, 112)],
    "blue_mine": [(39, 125, 0), (255, 255, 112)],
    ...
    while state == State.mine:
        if step == -1:
            ...
            while step == -1:
                ...
                # )
                angle, points = color_detect_sill(colors["next"], 600, grad, ksizes, defaults)
        ...
        if step == 0:
            ...
            while step == 0:
                ...
                # 获取数据
                angle, points = color_detect_sill(color, area_min, grad, ksizes, defaults)
                center_x, center_y = points[0]
                if center_x < 300:
                    self_flag = 0
                else:
