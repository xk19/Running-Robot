...
color_dist = {'red': {'Lower': np.array([0, 160, 100]), 'Upper': np.array([180, 255, 250])},
              ...
              'ball_red': {'Lower': np.array([0 , 155 , 226]), 'Upper': np.array([179 , 220 , 255])},
              'blue_hole': {'Lower': np.array([96 , 104 , 234]), 'Upper': np.array([99 , 135 , 255])},
    ...
    if True:
        ...
        if step == 0:   # 发现球，发现球洞，记录球与球洞的相对位置
            ...
            if Chest_ball_flag == True:   # 前进到球跟前
                if fast_run:
                    ...
                    if Chest_ball_y <340:
                        ...
                        elif Chest_ball_x < 220:
                            print("159L Chest_ball_x < 220 左侧移 ",Chest_ball_x)
                            action_append("Left3move")
                        else:
                            print("168L 前挪一点点 1111111 ",Chest_ball_y)
                            action_append("Forwalk00")
                            #action_append("forwardSlow0403")
                    else: # Chest_ball_y>390
            ...
            if Chest_ball_y <= 330:
                ...
                print("1903L 后一步 Back2Run > 410",Chest_ball_y)
                action_append("Back2Run")
            elif 330< Chest_ball_y <= 360:
        ...
        if 0<=step < 8: #踢球的七步
          ...
          # chest 球洞处理
            ...
            if img_debug:
                ...
                # cv2.imwrite('./Hole_OrgFrame.jpg', Hole_OrgFrame)        #查看识别情况
