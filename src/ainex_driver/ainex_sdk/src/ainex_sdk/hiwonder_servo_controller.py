...
class HiwonderServoController:
    ...
    def set_servo_position(self, servo_id, position, duration=None):
        ...
        if servo_id == 11 or servo_id == 12:
            position = 370 if position < 370 else position
            position = 570 if position > 570 else position
        if servo_id == 21:
            position = 200 if position < 200 else position
            position = 640 if position > 640 else position
        if servo_id == 22:
            position = 360 if position < 360 else position
            position = 800 if position > 800 else position
    ...
    def set_servos_position(self, duration, args):
        ...
        for arg in args[0]:
            ...
            if _id == 11 or _id == 12:
                _pulse = 370 if _pulse < 370 else _pulse
                _pulse = 570 if _pulse > 570 else _pulse
            if _id == 21:
                _pulse = 200 if _pulse < 200 else _pulse
                _pulse = 640 if _pulse > 640 else _pulse
            if _id == 22:
                _pulse = 360 if _pulse < 360 else _pulse
                _pulse = 800 if _pulse > 800 else _pulse
